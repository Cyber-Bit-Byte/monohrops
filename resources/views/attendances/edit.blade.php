...
@section('page-title', __('Edit Attendance'))
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <form action="{{ route('attendances.update', $attendance) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="date" name="date" type="date" value="{{ old('date', $attendance->date->format('Y-m-d')) }}" class="mt-1 block w-full" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input id="check_in" name="check_in" type="time" value="{{ old('check_in', $attendance->check_in) }}" class="mt-1 block w-full" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input id="check_out" name="check_out" type="time" value="{{ old('check_out', $attendance->check_out) }}" class="mt-1 block w-full">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="notes" name="notes" class="mt-1 block w-full">{{ old('notes', $attendance->notes) }}</textarea>
                        @error('notes') <div class="text-red-500">{{ $message }}</div> @enderror
                    </div>

                    <button type="submit" class="bg-cyan-500 hover:bg-cyan-700 text-white font-bold py-2 px-4 rounded">{{ __('Update Attendance') }}</button>
                </form>
            </div>
        </div>
    </div>
