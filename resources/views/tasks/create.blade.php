...
@section('page-title', __('Add Task'))
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <form action="{{ route('tasks.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="title" name="title" value="{{ old('title') }}" class="mt-1 block w-full" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input id="due_date" name="due_date" type="date" value="{{ old('due_date', now()->addWeek()->format('Y-m-d')) }}" class="mt-1 block w-full" required>
                    ...
                    <button type="submit" class="bg-cyan-500 hover:bg-cyan-700 text-white font-bold py-2 px-4 rounded">{{ __('Save Task') }}</button>
                </form>
            </div>
        </div>
    </div>
